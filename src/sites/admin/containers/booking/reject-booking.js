    ...
    reject = (type) => {
        ...
        if (type == 1) {
            ...
            bookingProvider.approved(dataBooking.booking.id, object).then(s => {
                if (s && s.code == 0) {
                    toast.success("Từ chối đặt khám của bệnh nhân thành công!", {
                ...
                toast.error("Từ chối đặt khám của bệnh nhân không thành công!", {
                    position: toast.POSITION.TOP_RIGHT
                });
                // this.handleClose();
            })
    ...
    render() {
        ...
        return (
            <div style={{ backgroundColor: 'red' }}>
                            ...
                            <Grid container spacing={16}>
                                <Grid item xs={12} md={12}>
                                    <TextValidator
                                        ...
                                        errorMessages={['Lý do từ chối không được bỏ trống!', 'Lý do từ chối không được bỏ trống!', 'Không cho phép nhập quá 500 kí tự!']}
                                    />
                                </Grid>
                            </Grid>
                        </DialogContent>
                ...
                {this.state.confirmDialog && <ConfirmDialog title="Xác nhận" content={"Bạn đang thực hiện từ chối đặt khám của bệnh nhân " +  (dataBooking.medicalRecords||{}).name} btnOk="Xác nhận" btnCancel="Hủy" cbFn={this.reject.bind(this)} />}
            </div >
        );
    }
}
